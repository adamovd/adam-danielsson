...
// Query: *[_type == 'page' && slug.current == $slug][0]{    _id,    name,    slug,    heading,    subheading,    content[]{      ...,      _type == "hero" => {          _type,  _key,  body,  image      }      // Add more block types here as needed    },  }
export type GetPageQueryResult = {
  ...
  content: Array<
    ...
    | {
        ...
        display?: 'carousel' | 'inline' | 'stacked';
        zoom?: boolean;
      }
    | {
        _key: string;
        ...
        verticalPosition?: 'center' | 'end' | 'start';
