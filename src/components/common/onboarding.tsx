    ...
    <div className="mx-auto grid max-w-2xl grid-flow-row gap-6 rounded-lg bg-red-500 p-8 py-12 text-center text-white">
      ...
      {process.env.NEXT_PUBLIC_SANITY_STUDIO_URL /* eslint-enable */ ? (
        <OnboardingMessage
          ...
          link={{
            title: 'Create Post',
            href: `${process.env.NEXT_PUBLIC_SANITY_STUDIO_URL || 'http://localhost:3333'}/structure/intent/create/template=post;type=post;path=title`,
          }}
        />
      ) : (
    ...
    <div className="mx-auto grid max-w-2xl grid-flow-row gap-6 rounded-lg bg-red-500 p-8 py-12 text-center text-white">
      ...
      {process.env.NEXT_PUBLIC_SANITY_STUDIO_URL /* eslint-enable */ ? (
        <OnboardingMessage
          ...
          link={{
            title: 'Create Page',
            href: `${process.env.NEXT_PUBLIC_SANITY_STUDIO_URL || 'http://localhost:3333'}/structure/intent/create/template=page;type=page;path=name`,
          }}
        />
      ) : (
        // if NEXT_PUBLIC_SANITY_STUDIO_URL environment variable is not set, Link to documentation to deploy a studio
